...
class Robot_player(Robot):
    ...
    def step(self, sensors, sensor_view=None, sensor_robot=None, sensor_team=None):
        ...
        rotation = (sensor_to_robot[sensor_front_right] - sensor_to_robot[sensor_front_left]) + (sensor_to_robot[sensor_right] - sensor_to_robot[sensor_left]) + (sensor_to_robot[sensor_rear_right] - sensor_to_robot[sensor_rear_left])#A MODIFIER
